...
//       if (jobId != null) {
//         print(jobId);
//         final jobSnapshot = await Firestore.instance
//           .collection('jobs')
//           .document(jobId)
//           .get();
//         print(jobSnapshot);
//         print(jobSnapshot['title']);
//       }
//     }
//     _isInit = false;
//   }
...
//           .collection('jobs')
//           .document();
//       jobData.id = jobRef.documentID;
//       await jobRef.setData(jobData.toMap());
...
//                         if (element['code'] > _initValues['code']) {
//                           _initValues['code'] = element['code'] + 1;
//                         }
//                       });
//                       return Text(
//                         'Job #${_initValues['code']}',
//                         style: Theme.of(context).textTheme.headline6,
//                       );
//                     },
//                   ),
